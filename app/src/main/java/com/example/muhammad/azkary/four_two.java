...
public class four_two extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mp1 = MediaPlayer.create(four_two.this,R.raw.mishary1);
        mp2 = MediaPlayer.create(four_two.this,R.raw.mishary2);
        mp3 = MediaPlayer.create(four_two.this,R.raw.mishary3);
        mp4 = MediaPlayer.create(four_two.this,R.raw.mishary4);
        mp5 = MediaPlayer.create(four_two.this,R.raw.mishary5);
        mp6 = MediaPlayer.create(four_two.this,R.raw.mishary6);
        mp7 = MediaPlayer.create(four_two.this,R.raw.mishary7);
        ...
        read.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(four_two.this,read.class );
