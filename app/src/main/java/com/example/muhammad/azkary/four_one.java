...
public class four_one extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mp1 = MediaPlayer.create(four_one.this,R.raw.mishary1);
        mp2 = MediaPlayer.create(four_one.this,R.raw.mishary2);
        mp3 = MediaPlayer.create(four_one.this,R.raw.mishary3);
        mp4 = MediaPlayer.create(four_one.this,R.raw.mishary4);
        mp5 = MediaPlayer.create(four_one.this,R.raw.mishary5);
        mp6 = MediaPlayer.create(four_one.this,R.raw.mishary6);
        mp7 = MediaPlayer.create(four_one.this,R.raw.mishary7);
        ...
        switch (i) {
            case 0:
                ...
                image_type.setImageResource(R.drawable.sun);
                break;
            case 1:
                text_type.setText("اذكار المساء");
                image_type.setImageResource(R.drawable.moon);
                break;
            case 2:
                text_type.setText("دعاء السفر ");
                image_type.setImageResource(R.drawable.plane4);
                break;
            case 3:
                text_type.setText("ركوب الدابه");
                image_type.setImageResource(R.drawable.car3);
                break;
            case 4:
                text_type.setText("دعاء دخول السوق");
                image_type.setImageResource(R.drawable.shopping);
                break;
            case 5:
                text_type.setText("دخول المسجد ");
                image_type.setImageResource(R.drawable.mosque3);
                break;

            case 6:
                text_type.setText("الاستيقاظ من النوم ");
                image_type.setImageResource(R.drawable.bed3);
                break;
        }
        ...
        read.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
               ...
               Intent intent = new Intent(four_one.this,read.class );
